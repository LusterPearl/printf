 ...
 * @ind: index at which the bnumber starts on the buffer
 * @buffer: buffer
 * @flags: flags
 * @width: width
 ...
 * @is_negative: Number indiciating if the num is negative
...
int write_unsgnd(int is_negative, int ind,
		...
		int flags, int width, int precision, int size)
{
	/* The number is stored at the buffer's right and start's at position i */
